...
public class NettyUDTSocketGateway extends NettyTCPSocketGateway {
	...
	protected void __start() {
		...
		bossGroup = new NioEventLoopGroup(2, acceptFactory, NioUdtProvider.BYTE_PROVIDER);
		workerGroup = new NioEventLoopGroup(4, connectFactory, NioUdtProvider.BYTE_PROVIDER);
